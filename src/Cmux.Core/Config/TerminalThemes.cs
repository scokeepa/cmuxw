...
public static class TerminalThemes
{
    ...
    public static Dictionary<string, TerminalTheme> BuiltIn { get; } = new()
    {
        ...
        ["Default Light"] = new TerminalTheme
        {
            Name = "Default Light",
            Author = "cmuxw",
            Background = new TerminalColor(0xF8, 0xF8, 0xF8),
            ...
            Palette =
            [
                new(0x1F, 0x29, 0x37), new(0xDC, 0x26, 0x26), new(0x16, 0xA3, 0x4A), new(0x9A, 0x6B, 0x0A),
                new(0x25, 0x63, 0xEB), new(0x93, 0x3B, 0xC8), new(0x0F, 0x76, 0x8B), new(0x4B, 0x55, 0x63),
                new(0x6B, 0x72, 0x80), new(0xB9, 0x1C, 0x1C), new(0x15, 0x80, 0x3D), new(0x6F, 0x55, 0x00),
